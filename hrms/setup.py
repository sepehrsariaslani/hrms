...
def get_custom_fields():
	...
	return {
		"Company": [
			...
			{
				"fieldname": "qr_attendance_section",
				"fieldtype": "Section Break",
				"label": _("کد QR حضور و غیاب"),
			...
			},
			{
				...
				"fieldtype": "Long Text",
				"label": _("داده کد QR"),
				"description": _("داده رمزنگاری شده برای تولید کد QR — تغییر ندهید"),
				"insert_after": "qr_attendance_section",
				"read_only": 1,
			},
			{
			...
			{
				"fieldname": "qr_secret_key",
				"fieldtype": "Data",
				"label": _("کلید امنیتی QR"),
				"description": _("کلید امنیتی برای تأیید اعتبار کد QR — تغییر ندهید"),
				"insert_after": "qr_code_image",
				"read_only": 1,
				"hidden": 1,
			},
			{
				"fieldname": "qr_generated_on",
				"fieldtype": "Datetime",
				"label": _("تاریخ تولید کد QR"),
				"insert_after": "qr_secret_key",
				"read_only": 1,
				"hidden": 1,
			},
			{
				"fieldname": "qr_attendance_latitude",
				"fieldtype": "Float",
			...
			},
			{
				...
				"fieldtype": "Int",
				"label": _("شعاع مجاز QR (متر)"),
				"description": _("حداکثر فاصله کارمند از محل مجاز شرکت هنگام ثبت حضور با QR"),
				"insert_after": "qr_attendance_longitude",
				"default": 200,
			},
		],
		"Department": [
