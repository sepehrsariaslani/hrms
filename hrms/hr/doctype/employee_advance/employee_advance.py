...
class EmployeeAdvance(Document):
	...
	def set_expense_approver(self):
		...
		self.expense_approver_name = (
			frappe.db.get_value("User", expense_approver, "full_name", cache=True) if expense_approver else None
		)
