...
def get_custom_fields():
	return {
		...
		"Salary Slip": [
			...
			{
				"fieldname": "holiday_hours_iran",
				"fieldtype": "Float",
				"label": "ساعت کار در تعطیلات",
				"insert_after": "shortage_hours_iran",
				"read_only": 1,
				"default": "0",
			},
			{
				"fieldname": "late_minutes_iran",
				"fieldtype": "Float",
				"label": "تأخیر (دقیقه)",
				"insert_after": "holiday_hours_iran",
				"read_only": 1,
				"default": "0",
			},
			{
				"fieldname": "early_exit_minutes_iran",
				"fieldtype": "Float",
				"label": "خروج زودهنگام (دقیقه)",
				"insert_after": "late_minutes_iran",
				"read_only": 1,
				"default": "0",
			},
			{
				"fieldname": "night_hours_iran",
				"fieldtype": "Float",
				"label": "ساعت کاری شب",
				"insert_after": "early_exit_minutes_iran",
				"read_only": 1,
				"default": "0",
			},
			{
				...
				"fieldtype": "Currency",
				"label": "پایه سنوات ماهانه فیش (طبق تاریخ فیش)",
